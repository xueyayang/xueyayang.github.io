...
syn region mkdHLCode       start=/\v^\{\%\s*highlight.*\%.*\}/ end=/\v^\{\%\s*endhighlight.*\%.*\}$/ 
...
syn cluster mkdNonListItem contains=htmlItalic,htmlBold,htmlBoldItalic,mkdFootnotes,mkdID,mkdURL,mkdLink,mkdLinkDef,mkdLineBreak,mkdBlockquote,mkdCode,mkdIndentCode,mkdListItem,mkdRule,htmlH1,htmlH2,htmlH3,htmlH4,htmlH5,htmlH6,mkdHLCode
...
HtmlHiLink mkdHLCode        Identifier 
